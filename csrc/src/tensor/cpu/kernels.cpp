...
LMP_REGISTER_DISPATCH(ops::conv1d_stub, DeviceType::CPU, conv1d_cpu);
LMP_REGISTER_DISPATCH(ops::conv2d_stub, DeviceType::CPU, conv2d_cpu);
LMP_REGISTER_DISPATCH(ops::conv3d_stub, DeviceType::CPU, conv3d_cpu);
