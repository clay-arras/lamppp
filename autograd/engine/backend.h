...
struct AbstractBackend { // TODO(nlin): consider compile-time polymorphism, this not being static is costing ~10ns
    ...
    virtual TensorImpl greater_equal(const TensorImpl& a, const TensorImpl& b) = 0;
