...
DECLARE_DISPATCH(equal_fn, equal_stub);
DECLARE_DISPATCH(not_equal_fn, not_equal_stub);
DECLARE_DISPATCH(greater_equal_fn, greater_equal_stub);
DECLARE_DISPATCH(less_equal_fn, less_equal_stub);
DECLARE_DISPATCH(greater_fn, greater_stub);
DECLARE_DISPATCH(less_fn, less_stub);
...
REGISTER_DISPATCH(not_equal_stub, DeviceType::CPU, not_equal_cpu);
REGISTER_DISPATCH(not_equal_stub, DeviceType::CUDA, not_equal_cuda);

TensorImpl equal_cpu(const TensorImpl& a, const TensorImpl& b);
TensorImpl equal_cuda(const TensorImpl& a, const TensorImpl& b);

REGISTER_DISPATCH(equal_stub, DeviceType::CPU, equal_cpu);
REGISTER_DISPATCH(equal_stub, DeviceType::CUDA, equal_cuda);
...
REGISTER_DISPATCH(greater_equal_stub, DeviceType::CPU, greater_equal_cpu);
REGISTER_DISPATCH(greater_equal_stub, DeviceType::CUDA, greater_equal_cuda);
...
REGISTER_DISPATCH(less_equal_stub, DeviceType::CPU, less_equal_cpu);
REGISTER_DISPATCH(less_equal_stub, DeviceType::CUDA, less_equal_cuda);
...
REGISTER_DISPATCH(greater_stub, DeviceType::CPU, greater_cpu);
REGISTER_DISPATCH(greater_stub, DeviceType::CUDA, greater_cuda);

TensorImpl less_cpu(const TensorImpl& a, const TensorImpl& b);
TensorImpl less_cuda(const TensorImpl& a, const TensorImpl& b);

REGISTER_DISPATCH(less_stub, DeviceType::CPU, less_cpu);
REGISTER_DISPATCH(less_stub, DeviceType::CUDA, less_cuda);
