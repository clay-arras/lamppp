...
struct AddBackwardContext {
    ...
    AddBackwardContext(std::shared_ptr<Value> s, std::shared_ptr<Value> o, std::shared_ptr<Value> out)
...
struct MulBackwardContext {
    ...
    MulBackwardContext(std::shared_ptr<Value> s, std::shared_ptr<Value> o, std::shared_ptr<Value> out)
        : self(s), other(o), out(out) {}
};
...
struct PowBackwardContext {
    ...
    PowBackwardContext(std::shared_ptr<Value> s, std::shared_ptr<Value> o, std::shared_ptr<Value> out)
        : self(s), other(o), out(out) {}
};
