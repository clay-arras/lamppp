...
from rushlite._C import _Variable, _Tensor, dtype, device
    ...
    def _rec(x, depth=0):
        if isinstance(x, list):
            if len(shape) == depth:
                ...
                raise ValueError("Rushlite: array must be uniform")
            for i in x:
            ...
            raise ValueError("Rushlite: invalid input type")
    ...
    def __init__(
        ...
        *args,
        ...
        if len(args) == 1 and isinstance(args[0], list):
            ...
            raise ValueError("Rushlite: invalid Tensor constructor arguments")
